...
public class Main {
  ...
  public static void printKnightsTour(int[][] chess, int row, int col, int moveNumber) {
    ...
    // check if it's the last possible move on the chess board
    ...
    // filling move number in the matrix (chess board)
    chess[row][col] = moveNumber;

    // each possible knight (horse) move in clockwise order
