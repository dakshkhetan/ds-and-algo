...
public class Main {
  ...
  public static boolean findNode(BinaryTreeNode root, int x) {
    if (root == null) {
      return false;
    }
    ...
    boolean leftAns = findNode(root.left, x);
    boolean rightAns = findNode(root.right, x);
  ...
  public static void main(String[] args) throws Exception {
    ...
    boolean result = findNode(root, x);
